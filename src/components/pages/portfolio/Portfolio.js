              ...
              <h2>My Projects</h2>
                    ...
                    <div className='card'>
                      ...
                      <a href="https://gracious-visvesvaraya-f4d7f5.netlify.app" 
                        ...
                        <p>
                          ...
                          technicians.
                          <br></br> 
                          <a href='https://github.com/NtombekaziSibetyu/IT-Logger' target='_blank'>GitHub</a>
                        </p>  
                    </div>      
                  </div>
                </div>
                <div className="row">
                  <div className='col-6'>
                    ...
                    <a href="https://rocky-beyond-49433.herokuapp.com/"
                      ...
                      <img className='card-img' 
                        ...
                        <p>
                        <a href='https://github.com/NtombekaziSibetyu/final-project' target=''>GitHub</a>
                        </p>
                    </div>
                  </div>
                  <div className="col-6">
                  ...
                  <a href="https://ntombekazi-weather-widget.netlify.app/"
                         target='_blank' >
                    <img className='card-img' 
                          src={img6} alt='weather widget' href='https://ntombekazi-weather-widget.netlify.app/'
                        ></img>       
                          </a>
                        ...
                        <p>
                        <a href='https://github.com/NtombekaziSibetyu/weather-widget' target='_blank'>GitHub</a>
                        </p>
                  </div>
                </div>
                </div>
